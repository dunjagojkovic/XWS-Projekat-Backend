...
var file_user_service_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x35, 0x0a, 0x0f, 0x45, 0x64, 0x69, 0x74,
	...
	0x32, 0xed, 0x03, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x69, 0x6e, 0x3a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x49, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x55,
	...
	0x65, 0x72, 0x73, 0x12, 0x50, 0x0a, 0x0b, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x55, 0x73,
	0x65, 0x72, 0x12, 0x18, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e,
	...
	0x12, 0x13, 0x2f, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x2f, 0x7b, 0x75, 0x73, 0x65, 0x72,
	0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x12, 0x42, 0x0a, 0x08, 0x45, 0x64, 0x69, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x12, 0x15, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x45, 0x64, 0x69, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	0x55, 0x73, 0x65, 0x72, 0x22, 0x13, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0d, 0x1a, 0x05, 0x2f, 0x65,
	0x64, 0x69, 0x74, 0x3a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x55, 0x0a, 0x0e, 0x47, 0x65, 0x74,
	0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x15, 0x2e, 0x75, 0x73,
	...
	0x02, 0x0e, 0x12, 0x0c, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x55, 0x73, 0x65, 0x72, 0x73,
...
var file_user_service_proto_goTypes = []interface{}{
	(*EditUserRequest)(nil),      // 0: user.EditUserRequest
	(*GetUsersRequest)(nil),      // 1: user.GetUsersRequest
	(*CurrentUserRequest)(nil),   // 2: user.CurrentUserRequest
	...
	(*RegistrationResponse)(nil), // 7: user.RegistrationResponse
	(*RegistrationRequest)(nil),  // 8: user.RegistrationRequest
	(*RegisterUser)(nil),         // 9: user.RegisterUser
	(*User)(nil),                 // 10: user.User
	(*EditUser)(nil),             // 11: user.EditUser
	(*WorkExperience)(nil),       // 12: user.WorkExperience
}
var file_user_service_proto_depIdxs = []int32{
	11, // 0: user.EditUserRequest.user:type_name -> user.EditUser
	10, // 1: user.GetUsersResponse.users:type_name -> user.User
	5,  // 2: user.LoginRequest.user:type_name -> user.LoginUserRequest
	9,  // 3: user.RegistrationRequest.user:type_name -> user.RegisterUser
	12, // 4: user.User.workExperiences:type_name -> user.WorkExperience
	12, // 5: user.EditUser.workExperience:type_name -> user.WorkExperience
	8,  // 6: user.UserService.Registration:input_type -> user.RegistrationRequest
	4,  // 7: user.UserService.Login:input_type -> user.LoginRequest
	1,  // 8: user.UserService.GetUsers:input_type -> user.GetUsersRequest
	2,  // 9: user.UserService.CurrentUser:input_type -> user.CurrentUserRequest
	0,  // 10: user.UserService.EditUser:input_type -> user.EditUserRequest
	1,  // 11: user.UserService.GetPublicUsers:input_type -> user.GetUsersRequest
	7,  // 12: user.UserService.Registration:output_type -> user.RegistrationResponse
	...
	10, // 15: user.UserService.CurrentUser:output_type -> user.User
	10, // 16: user.UserService.EditUser:output_type -> user.User
	3,  // 17: user.UserService.GetPublicUsers:output_type -> user.GetUsersResponse
