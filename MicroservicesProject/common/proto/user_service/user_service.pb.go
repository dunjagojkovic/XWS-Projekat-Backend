...
var file_user_service_proto_rawDesc = []byte{
	...
	0x52, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xed, 0x07,
	...
	0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x55, 0x73, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x42, 0x0d, 0x5a,
...
var file_user_service_proto_depIdxs = []int32{
	...
	17, // 22: user.UserService.Registration:output_type -> user.RegistrationResponse
	16, // 23: user.UserService.Login:output_type -> user.LoginResponse
	20, // 24: user.UserService.EditPassword:output_type -> user.User
	20, // 25: user.UserService.EditPrivacy:output_type -> user.User
	13, // 26: user.UserService.GetUsers:output_type -> user.GetUsersResponse
	20, // 27: user.UserService.CurrentUser:output_type -> user.User
	20, // 28: user.UserService.EditUser:output_type -> user.User
	13, // 29: user.UserService.GetPublicUsers:output_type -> user.GetUsersResponse
	6,  // 30: user.UserService.FilterUsers:output_type -> user.FilterUsersResponse
	20, // 31: user.UserService.GetUser:output_type -> user.User
	13, // 32: user.UserService.GetUsersById:output_type -> user.GetUsersResponse
	1,  // 33: user.UserService.BlockUser:output_type -> user.GetUserRequest
